...
public class ImageDriverSelectorDialog extends JDialog {
	...
	private class OkButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			config.lockConfig();
			config.setImageDriverClassName(selection);
			config.unlockConfig();
			ImageDriverSelectorDialog.this.setVisible(false);
		}
	}
	 ...
	 * Create the dialog.
	 */
	public ImageDriverSelectorDialog(VisionRuntimeConfig config) {
		...
		for(Class<?> c : Vision.getRuntime().getAvailableImageDrivers()) {
			clist.add(c.getName());
		}
